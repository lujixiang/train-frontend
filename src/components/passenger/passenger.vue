  ...
  <div class="passenger-content">
      ...
      <div class="passengers">
        <div class="person-info">
          <div class="info">
            ...
            <template v-if="item.idcardno === '' || item.IdNo === '' || !checkID(item.IdNo)">
              <div class="id">
                <span>
    ...
    <template v-if="action !== 'endorse' && action !== 'rebooking'">
      <div class="add-passenger">
        <span class="add-text">添加乘车人</span>
        <ykb-icon type="addPeople" className="add-button" :onclick="addPassenger"></ykb-icon>
      </div>
            ...
            _.forEach(res.train_passenger, item => {
              if (item.endorse) {
                this.passengers.push({
                  ...
                  idcardno: fun.encryptIDNo(item.passportseno), // item.passportseno.replace(/^(\d{4})(\d+)(\d{4})$/, '$1**********$3'),
